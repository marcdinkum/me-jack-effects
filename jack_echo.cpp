...
*********************************************************************
*
* File name     : jack_echo.cpp
* System name   : digital effects
* 
*
* Description   : echo with JACK interface
*
*
* Author        : Marc_G
...
#define DELAYTAPS 4096

int delay_index=0;


jack_default_audio_sample_t delayline[DELAYTAPS];
...
int process(jack_nframes_t nframes, void *arg)
{
  ...
  {
    out[x]=in[x]/2;
    out[x]+=delayline[delay_index];
    out[x]/=2;
    delayline[delay_index]=out[x];
    delay_index++;
    delay_index%=DELAYTAPS;
  }
...
const char **ports;
  ...
  if( (client=jack_client_open("echo",(jack_options_t)0,0)) == 0)
  {
